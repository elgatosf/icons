...
const IconZoomOut = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M7 10.5C7 10.0858 7.33579 9.75 7.75 9.75L13.25 9.75C13.6642 9.75 14 10.0858 14 10.5C14 10.9142 13.6642 11.25 13.25 11.25H7.75C7.33579 11.25 7 10.9142 7 10.5Z" />
			<path
				fillRule="evenodd"
				clipRule="evenodd"
