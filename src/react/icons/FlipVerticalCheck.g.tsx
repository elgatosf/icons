	...
	return (
		...
		>
			<path
				...
				clipRule="evenodd"
			/>
			<path d="M11.47 14.47a.75.75 0 0 1 .392-.207 6.46 6.46 0 0 0-.846 2.782L8.56 19.5h2.752c.173.534.412 1.037.709 1.5H6.75a.75.75 0 0 1-.53-1.28zM3 12c0 .414.336.75.75.75h8.5a.75.75 0 0 0 0-1.5h-8.5A.75.75 0 0 0 3 12" />
			<path
				fillRule="evenodd"
