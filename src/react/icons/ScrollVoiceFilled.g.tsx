...
const IconScrollVoiceFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path
				fillRule="evenodd"
				d="M16.5 6A2.5 2.5 0 0 0 14 8.5v4a2.5 2.5 0 0 0 5 0v-4A2.5 2.5 0 0 0 16.5 6"
				clipRule="evenodd"
			/>
...
IconScrollVoiceFilled.iconName = "scroll-voice--filled";

export default IconScrollVoiceFilled;
