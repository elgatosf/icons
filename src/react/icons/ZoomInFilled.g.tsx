	...
	return (
		...
		>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M15 10.5C15 12.9853 12.9853 15 10.5 15C8.01472 15 6 12.9853 6 10.5C6 8.01472 8.01472 6 10.5 6C12.9853 6 15 8.01472 15 10.5ZM10.5 7.5C10.9142 7.5 11.25 7.83579 11.25 8.25V9.75H12.75C13.1642 9.75 13.5 10.0858 13.5 10.5C13.5 10.9142 13.1642 11.25 12.75 11.25H11.25V12.75C11.25 13.1642 10.9142 13.5 10.5 13.5C10.0858 13.5 9.75 13.1642 9.75 12.75V11.25H8.25C7.83579 11.25 7.5 10.9142 7.5 10.5C7.5 10.0858 7.83579 9.75 8.25 9.75H9.75V8.25C9.75 7.83579 10.0858 7.5 10.5 7.5Z"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
