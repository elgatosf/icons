...
const IconStreamDeckKeyBottomFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconStreamDeckKeyBottomFilled.iconName = "stream-deck-key-bottom--filled";

export default IconStreamDeckKeyBottomFilled;
