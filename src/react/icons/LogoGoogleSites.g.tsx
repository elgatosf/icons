...
const IconLogoGoogleSites = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M8 11H16V12.5H8V11Z" />
			<path d="M16 14H14.5V18H16V14Z" />
			<path d="M8 14H13V18H8V14Z" />
			<path
				fillRule="evenodd"
				clipRule="evenodd"
...
IconLogoGoogleSites.iconName = "logo-google-sites";

export default IconLogoGoogleSites;
