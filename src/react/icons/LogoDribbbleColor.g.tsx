...
const IconLogoDribbbleColor = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconLogoDribbbleColor.iconName = "logo-dribbble--color";

export default IconLogoDribbbleColor;
