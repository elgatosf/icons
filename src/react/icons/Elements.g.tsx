	...
	return (
		...
		>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M10 5.5H20C20.2761 5.5 20.5 5.72386 20.5 6V12C20.5 12.2761 20.2761 12.5 20 12.5H10C9.72386 12.5 9.5 12.2761 9.5 12V6C9.5 5.72386 9.72386 5.5 10 5.5ZM20 4C21.1046 4 22 4.89543 22 6V12C22 13.1046 21.1046 14 20 14H10C8.89543 14 8 13.1046 8 12V6C8 4.89543 8.89543 4 10 4H20Z"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
