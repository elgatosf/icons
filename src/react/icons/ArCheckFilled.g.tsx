...
const IconArCheckFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M2.75 2a.75.75 0 0 0-.75.75v2.5a.75.75 0 0 0 1.5 0V3.5h1.75a.75.75 0 0 0 0-1.5zM2 18.75v2.5a.75.75 0 0 0 .75.75h2.5a.75.75 0 0 0 0-1.5H3.5v-1.75a.75.75 0 0 0-1.5 0M22 5.25v-2.5a.75.75 0 0 0-.75-.75h-2.5a.75.75 0 0 0 0 1.5h1.75v1.75a.75.75 0 0 0 1.5 0M11 4.495a2 2 0 0 1 2 0l5 2.886a2 2 0 0 1 .23.156L12 11.134 5.77 7.537q.108-.085.23-.156zM18.98 8.836l-6.23 3.597v.63A6.48 6.48 0 0 1 17.5 11q.776.002 1.5.174v-2.06q0-.141-.02-.278M11.25 12.433v3.276c-.163.569-.25 1.17-.25 1.791s.087 1.222.25 1.791v.337a2 2 0 0 1-.25-.122l-5-2.887a2 2 0 0 1-1-1.732V9.113q0-.14.02-.277z" />
			<path
				fillRule="evenodd"
