...
const IconShuffle = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path d="M13.413 14.378a.75.75 0 0 0-1.264.809l.45.702A6.75 6.75 0 0 0 18.283 19h1.155l-1.22 1.22a.75.75 0 1 0 1.061 1.06l2.5-2.5a.75.75 0 0 0 0-1.06l-2.5-2.5a.75.75 0 1 0-1.06 1.06l1.22 1.22h-1.156a5.25 5.25 0 0 1-4.422-2.42z" />
		</svg>
	);
};
