...
const IconEyeContactFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path
				fillRule="evenodd"
				d="M3.71 12.825a1.5 1.5 0 0 1 0-1.65C4.788 9.54 7.624 6 12 6s7.212 3.54 8.29 5.175c.329.5.329 1.15 0 1.65C19.211 14.46 16.376 18 12 18s-7.213-3.54-8.29-5.175M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6"
				clipRule="evenodd"
			/>
		</svg>
	);
