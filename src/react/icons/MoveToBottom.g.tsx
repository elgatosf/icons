...
const IconMoveToBottom = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path d="M21 16.25C21 16.6642 20.6642 17 20.25 17L3.75 17C3.33579 17 3 16.6642 3 16.25C3 15.8358 3.33579 15.5 3.75 15.5L20.25 15.5C20.6642 15.5 21 15.8358 21 16.25Z" />
		</svg>
	);
};
