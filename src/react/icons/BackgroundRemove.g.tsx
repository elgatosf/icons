...
const IconBackgroundRemove = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconBackgroundRemove.iconName = "background-remove";

export default IconBackgroundRemove;
