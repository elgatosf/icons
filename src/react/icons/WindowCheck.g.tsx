	...
	return (
		...
		>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M2 6C2 4.89543 2.89543 4 4 4H20C21.1046 4 22 4.89543 22 6V12.1506C21.5456 11.7688 21.042 11.4438 20.5 11.1863V9H3.5V18C3.5 18.2761 3.72386 18.5 4 18.5H10.5691C10.6426 19.0206 10.7733 19.5228 10.9548 20H4C2.89543 20 2 19.1046 2 18V6ZM4 5.5H20C20.2761 5.5 20.5 5.72386 20.5 6V7.5H3.5V6C3.5 5.72386 3.72386 5.5 4 5.5Z"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
