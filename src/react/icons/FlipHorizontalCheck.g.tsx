...
const IconFlipHorizontalCheck = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M11.25 3.75a.75.75 0 0 1 1.5 0v8.5a.75.75 0 0 1-1.5 0z" />
			<path
				fillRule="evenodd"
				d="M3 17.25a.75.75 0 0 0 1.28.53l5.25-5.25a.75.75 0 0 0 0-1.06L4.28 6.22A.75.75 0 0 0 3 6.75zM7.94 12 4.5 15.44V8.56z"
				clipRule="evenodd"
			/>
			<path d="M21 6.75v5.272a6.5 6.5 0 0 0-1.5-.709V8.561l-2.455 2.455a6.46 6.46 0 0 0-2.782.846.75.75 0 0 1 .207-.392l5.25-5.25a.75.75 0 0 1 1.28.53" />
			<path
				fillRule="evenodd"
