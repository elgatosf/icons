...
const IconFlashOff = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path
				fillRule="evenodd"
				d="m14.74 15.801 3.98 3.98a.75.75 0 1 0 1.06-1.061L5.28 4.22a.75.75 0 0 0-1.06 1.06l4.027 4.028-4.05 4.436A.75.75 0 0 0 4.75 15h5.221l-1.935 6.02a.75.75 0 0 0 1.268.736zM13.68 14.74l-4.37-4.37L6.45 13.5H11a.75.75 0 0 1 .714.98l-1.196 3.722z"
				clipRule="evenodd"
			/>
		</svg>
	);
