		...
		default:
			return (
				<svg
					...
					{...props}
				>
					<path d="M7.75 7a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5zM7 11.75a.75.75 0 0 1 .75-.75h8.5a.75.75 0 0 1 0 1.5h-8.5a.75.75 0 0 1-.75-.75M7.75 15a.75.75 0 0 0 0 1.5h4.5a.75.75 0 0 0 0-1.5z" />
					<path
						fillRule="evenodd"
