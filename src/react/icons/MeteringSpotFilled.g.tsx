...
const IconMeteringSpotFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconMeteringSpotFilled.iconName = "metering-spot--filled";

export default IconMeteringSpotFilled;
