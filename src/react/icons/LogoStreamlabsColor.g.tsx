...
const IconLogoStreamlabsColor = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconLogoStreamlabsColor.iconName = "logo-streamlabs--color";

export default IconLogoStreamlabsColor;
