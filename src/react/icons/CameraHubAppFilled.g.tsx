...
const IconCameraHubAppFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconCameraHubAppFilled.iconName = "camera-hub-app--filled";

export default IconCameraHubAppFilled;
