...
const IconLogoPerplexityColor = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconLogoPerplexityColor.iconName = "logo-perplexity--color";

export default IconLogoPerplexityColor;
