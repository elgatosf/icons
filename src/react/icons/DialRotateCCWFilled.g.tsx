	...
	return (
		...
		>
			...
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M19 13C19 16.866 15.866 20 12 20C8.13401 20 5 16.866 5 13C5 9.13401 8.13401 6 12 6C15.866 6 19 9.13401 19 13ZM8.21967 9.21967C8.51256 8.92678 8.98744 8.92678 9.28033 9.21967L11.7803 11.7197C12.0732 12.0126 12.0732 12.4874 11.7803 12.7803C11.4874 13.0732 11.0126 13.0732 10.7197 12.7803L8.21967 10.2803C7.92678 9.98744 7.92678 9.51256 8.21967 9.21967Z"
			/>
		</svg>
	);
};
