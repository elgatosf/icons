...
const IconCameraInputCheck = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path d="M16.33 10.5q.157.272.279.56c-.513.07-1.007.201-1.474.384a3.5 3.5 0 0 0-4.885-1.475.75.75 0 0 1-.75-1.3 5 5 0 0 1 6.83 1.831M11 17.5q0-.572.096-1.119a3.5 3.5 0 0 1-.846-.35.75.75 0 0 0-.75 1.3c.472.271.983.464 1.512.57A7 7 0 0 1 11 17.5M12.022 21a6.5 6.5 0 0 1-.709-1.5H4a.5.5 0 0 1-.5-.5v-3A.75.75 0 0 0 2 16v3a2 2 0 0 0 2 2zM2 13a.75.75 0 0 1 .75-.75h4.629l-1.47-1.47a.75.75 0 1 1 1.06-1.06l2.75 2.75a.75.75 0 0 1 0 1.06l-2.75 2.75a.75.75 0 0 1-1.06-1.06l1.47-1.47H2.75A.75.75 0 0 1 2 13" />
			<path
				fillRule="evenodd"
