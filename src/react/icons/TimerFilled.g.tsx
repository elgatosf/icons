	...
	return (
		...
		>
			...
			<path
				...
				clipRule="evenodd"
			/>
			<path d="M2.984 6.813a.75.75 0 0 1 0-1.06l1.768-1.769a.75.75 0 0 1 1.06 1.061L4.046 6.813a.75.75 0 0 1-1.06 0M18.187 3.984a.75.75 0 0 1 1.06 0l1.768 1.768a.75.75 0 0 1-1.06 1.06l-1.768-1.767a.75.75 0 0 1 0-1.06" />
		</svg>
	);
};

IconTimerFilled.iconName = "timer--filled";
