...
const IconAr = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path
				fillRule="evenodd"
				d="M13 4.494a2 2 0 0 0-2 0L6 7.381a2 2 0 0 0-1 1.732v5.774a2 2 0 0 0 1 1.732l5 2.887a2 2 0 0 0 2 0l5-2.887a2 2 0 0 0 1-1.732V9.113a2 2 0 0 0-1-1.732zm3.75 3.898-4.5-2.598a.5.5 0 0 0-.5 0l-4.5 2.598L12 11.134zm.75 1.299-4.75 2.742v5.485l4.5-2.598a.5.5 0 0 0 .25-.433zm-6.25 8.227v-5.485L6.5 9.691v5.196a.5.5 0 0 0 .25.433z"
				clipRule="evenodd"
			/>
		</svg>
	);
