		...
		case "l":
			return (
				<svg
					...
					{...props}
				>
					<path d="M11.25 5.615a7.29 7.29 0 0 0-9.03 1.02.75.75 0 0 0-.22.53V18.75a.75.75 0 0 0 1.28.53 5.79 5.79 0 0 1 7.97-.208zM12.75 19.072a5.79 5.79 0 0 1 7.97.208.75.75 0 0 0 1.28-.53V7.166a.75.75 0 0 0-.22-.53 7.29 7.29 0 0 0-9.03-1.021z" />
				</svg>
			);
		default:
			return (
