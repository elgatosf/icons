		...
		default:
			return (
				<svg
					...
					{...props}
				>
					<path d="M2.5 2.5A.5.5 0 0 1 3 2h1.5a.5.5 0 0 1 .5.5V7h1a.5.5 0 0 1 0 1H3a.5.5 0 1 1 0-1h1V3H3a.5.5 0 0 1-.5-.5M8 4.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5M6 18H2.5c-.22 0-.41-.14-.48-.35s.02-.44.2-.56C3.29 16.37 5 14.9 5 14.01c0-.23-.09-1-1-1-.67 0-1.05.72-1.05.73-.13.24-.43.34-.67.22a.496.496 0 0 1-.22-.67l.007-.012c.076-.139.697-1.268 1.943-1.268 1.47 0 2 1.2 2 2 0 1.06-1.1 2.22-2.02 3h2.02c.28 0 .5.22.5.5s-.22.5-.5.5zM8.5 14a.5.5 0 0 0 0 1h8a.5.5 0 0 0 0-1zM8.5 9a.5.5 0 1 0 0 1h8a.5.5 0 0 0 0-1z" />
				</svg>
			);
	}
};
