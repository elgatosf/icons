	...
	return (
		...
		>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M10.5 15C12.9853 15 15 12.9853 15 10.5C15 8.01472 12.9853 6 10.5 6C8.01472 6 6 8.01472 6 10.5C6 12.9853 8.01472 15 10.5 15ZM8.25 9.75C7.83579 9.75 7.5 10.0858 7.5 10.5C7.5 10.9142 7.83579 11.25 8.25 11.25H12.75C13.1642 11.25 13.5 10.9142 13.5 10.5C13.5 10.0858 13.1642 9.75 12.75 9.75H8.25Z"
			/>
			<path
				fillRule="evenodd"
				clipRule="evenodd"
