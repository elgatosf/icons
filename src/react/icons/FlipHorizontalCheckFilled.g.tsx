...
const IconFlipHorizontalCheckFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M11.25 3.75a.75.75 0 0 1 1.5 0v8.5a.75.75 0 0 1-1.5 0zM3 17.25a.75.75 0 0 0 1.28.53l5.25-5.25a.75.75 0 0 0 0-1.06L4.28 6.22A.75.75 0 0 0 3 6.75zM21 6.75v5.272A6.47 6.47 0 0 0 17.5 11a6.47 6.47 0 0 0-3.237.862.75.75 0 0 1 .207-.392l5.25-5.25a.75.75 0 0 1 1.28.53" />
			<path
				fillRule="evenodd"
