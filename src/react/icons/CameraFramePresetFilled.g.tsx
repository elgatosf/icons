...
const IconCameraFramePresetFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path
				fillRule="evenodd"
				clipRule="evenodd"
				d="M5 7C5 5.89543 5.89543 5 7 5H17C18.1046 5 19 5.89543 19 7V17C19 18.1046 18.1046 19 17 19H7C5.89543 19 5 18.1046 5 17V7ZM15 6.5H17C17.2761 6.5 17.5 6.72386 17.5 7V17C17.5 17.2761 17.2761 17.5 17 17.5H7C6.72386 17.5 6.5 17.2761 6.5 17V15H13C14.1046 15 15 14.1046 15 13V6.5Z"
			/>
		</svg>
	);
};
