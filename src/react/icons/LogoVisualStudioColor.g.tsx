	...
	return (
		...
		>
			...
			>
				...
				<path
					fill="#fff"
					d="M21.629 5.47a.84.84 0 0 0-1.038.097l-.058.058L13.883 12l-3.68 3.53L6.8 18.791l-.059.058a.81.81 0 0 1-.575.233.84.84 0 0 1-.5-.166l-3.333-2.5a.833.833 0 0 0 1.133-.125l3.7-4.296 3.038-3.525 5.32-6.18a.82.82 0 0 1 .63-.291c.164 0 .325.047.462.138z"
				/>
				<path
					fill="#fff"
					d="m21.629 18.529-5 3.333a.844.844 0 0 1-1.096-.15l-5.33-6.183-3.037-3.533-3.7-4.292a.837.837 0 0 0-1.133-.12l3.333-2.5a.84.84 0 0 1 .81-.108q.151.061.265.174l.059.058 3.404 3.263L13.883 12l6.65 6.375.058.058a.8.8 0 0 0 .575.233.84.84 0 0 0 .463-.137"
				/>
				<path
					fill="#fff"
