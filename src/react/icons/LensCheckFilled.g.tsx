...
const IconLensCheckFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M12 22q.395 0 .78-.03A6.48 6.48 0 0 1 11 17.41 5.502 5.502 0 0 1 12 6.5c2.696 0 4.94 1.94 5.41 4.5h.09c1.732 0 3.305.677 4.47 1.78q.03-.385.03-.78c0-5.523-4.477-10-10-10S2 6.477 2 12s4.477 10 10 10" />
