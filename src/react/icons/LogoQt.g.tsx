...
const IconLogoQt = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M7.826 9.139q.447-.812 1.625-.81 1.18-.001 1.619.81.435.81.434 2.602c0 1.188-.143 2.04-.42 2.538q-.426.751-1.633.753c-.806 0-1.355-.26-1.639-.767-.285-.506-.427-1.357-.427-2.538 0-1.189.15-2.047.44-2.588" />
			<path
				fillRule="evenodd"
