...
const IconHeadphonesSwitchToFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path d="M5 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2z" />
			<path
				fillRule="evenodd"
...
IconHeadphonesSwitchToFilled.iconName = "headphones-switch-to--filled";

export default IconHeadphonesSwitchToFilled;
