...
const IconNumber7Square = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M11.8136 16.0001L14.7176 9.33412V8.04712H9.07458V9.27912H13.1116L9.92159 16.0001H11.8136Z" />
			<path
				fillRule="evenodd"
				clipRule="evenodd"
...
IconNumber7Square.iconName = "number7-square";

export default IconNumber7Square;
