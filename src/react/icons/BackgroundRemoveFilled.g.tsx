...
const IconBackgroundRemoveFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconBackgroundRemoveFilled.iconName = "background-remove--filled";

export default IconBackgroundRemoveFilled;
