...
const IconNotificationOffFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			<path
				fillRule="evenodd"
				d="M2.22 21.78a.75.75 0 0 1 0-1.06l18.5-18.5a.75.75 0 1 1 1.06 1.06l-4.023 4.024C17.915 7.842 18 8.41 18 9v3l1.414 1.414A2 2 0 0 1 20 14.828V16a2 2 0 0 1-2 2h-2.127a4 4 0 0 1-7.746 0H7.061l-3.78 3.78a.75.75 0 0 1-1.061 0M9.709 18a2.5 2.5 0 0 0 4.582 0z"
				clipRule="evenodd"
			/>
