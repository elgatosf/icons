...
const IconStreamSwitchTo = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconStreamSwitchTo.iconName = "stream-switch-to";

export default IconStreamSwitchTo;
