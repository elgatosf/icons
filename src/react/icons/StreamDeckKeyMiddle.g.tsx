		...
		case "l":
			return (
				<svg
					...
					{...props}
				>
					<path d="M7.75 11.25a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5z" />
					<path
						fillRule="evenodd"
		...
		case "s":
			return (
				<svg
					...
					{...props}
				>
					<path d="M10.5 7.5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1 0-1z" />
					<path
						fillRule="evenodd"
		...
		default:
			return (
				<svg
					...
					{...props}
				>
					<path d="M6.5 9.5a.5.5 0 0 0 0 1h7a.5.5 0 0 0 0-1z" />
					<path
						fillRule="evenodd"
