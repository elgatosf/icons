...
const IconLogoBitcoin = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		<svg
			...
			{...props}
		>
			<path d="M10.736 14.588c.896.236 2.852.753 3.163-.497.32-1.278-1.578-1.704-2.504-1.912l-.27-.062-.602 2.415zM11.58 11.058c.747.2 2.375.634 2.659-.502.29-1.162-1.293-1.513-2.066-1.684q-.132-.028-.226-.052l-.546 2.191z" />
			<path
				fillRule="evenodd"
