...
const IconGapHorizontalFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
	...
	return (
		...
		>
			...
			<path d="M17 17C15.8954 17 15 16.1046 15 15V9C15 7.89543 15.8954 7 17 7H19C20.1046 7 21 7.89543 21 9V15C21 16.1046 20.1046 17 19 17H17Z" />
			<path d="M3 15C3 16.1046 3.89543 17 5 17H7C8.10457 17 9 16.1046 9 15V9C9 7.89543 8.10457 7 7 7H5C3.89543 7 3 7.89543 3 9L3 15Z" />
		</svg>
	);
};
