		...
		default:
			return (
				<svg
					...
					{...props}
				>
					<path d="M2.75 2a.75.75 0 0 0-.75.75v2.5a.75.75 0 0 0 1.5 0V3.5h1.75a.75.75 0 0 0 0-1.5zM2 18.75v2.5a.75.75 0 0 0 .75.75h2.5a.75.75 0 0 0 0-1.5H3.5v-1.75a.75.75 0 0 0-1.5 0m20-13.5v-2.5a.75.75 0 0 0-.75-.75h-2.5a.75.75 0 0 0 0 1.5h1.75v1.75a.75.75 0 0 0 1.5 0" />
					<path
						fillRule="evenodd"
						d="M16 9c0 .912-.305 1.753-.82 2.426a6.5 6.5 0 0 0-2.268 1.47A4 4 0 1 1 16 9m-1.5 0a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"
						clipRule="evenodd"
					/>
					<path d="M6.343 16.843a8 8 0 0 1 5.387-2.338 6.5 6.5 0 0 0-.569 1.55 6.5 6.5 0 0 0-3.757 1.849.75.75 0 1 1-1.06-1.06Z" />
					<path
						fillRule="evenodd"
