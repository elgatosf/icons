...
const IconHeadphonesAddFilled = (props: IconProps & SVGProps<SVGSVGElement>) => {
...
IconHeadphonesAddFilled.iconName = "headphones-add--filled";

export default IconHeadphonesAddFilled;
